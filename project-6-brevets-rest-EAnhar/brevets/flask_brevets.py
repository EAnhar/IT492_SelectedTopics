...
def new():
    ...
    location = request.form.getlist("location", type=str)
...
if __name__ == "__main__":
    app.logger.info(f"Opening for global access on port {CONFIG.PORT2}")
    app.run(port=CONFIG.PORT2, host="0.0.0.0", debug=True)
